...
class SupersetDashboardConfig(models.Model):
    ...
    def create(self, vals_list):
        records = super(SupersetDashboardConfig, self).create(vals_list)
        self.create_menus() 
        return records

    def write(self, vals):
        res = super(SupersetDashboardConfig, self).write(vals)
        self.create_menus() 
        return res

    def unlink(self):
        res = super(SupersetDashboardConfig, self).unlink()
        self.create_menus()  
        return res
